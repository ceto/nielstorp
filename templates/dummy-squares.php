<?php for ($i=500; $i < 550; $i++) { ?>

<article class="offices residental post-<?php echo $i; ?> project type-project status-publish has-post-thumbnail hentry js-isotopeitem projectsquare project-<?php echo $i; ?>">
  
  <figure class="projectsquare__figure">
    <a href="http://ceto.no-ip.org/nielstorp/?project=jordan-airlines">
...
<article class="hotels urbanism post-<?php echo ++$i; ?> project type-project status-publish has-post-thumbnail hentry js-isotopeitem projectsquare project-<?php echo $i; ?>">
  ...
  <header class="projectsquare__datapanel">
    ...
    <p class="projectsquare__details">Some text here</p>
    </a>
  </header>
</article>
